...
//    }
    ...
    private void searchCustomer() {
        int id = (int) tableCustomer.getValueAt(tableCustomer.getSelectedRow(), 0);
        CustomerDto dto;
        try {
            dto = customerController.searchCustomer(id);
            if (dto != null) {
                txtID.setText(Integer.toString(dto.getCustId()));
